...
import study.project.pokelytics.adapters.PokemonFavAdapter
import study.project.pokelytics.api.model.Pokemon
import study.project.pokelytics.databinding.FragmentFavListBinding
...
class FavListFragment : FragmentBase<FragmentFavListBinding>() {

    private val viewModel: PokemonListViewModel by viewModel()
    private lateinit var adapter: PokemonFavAdapter
    ...
    override fun getResourceLayout(): Int = R.layout.fragment_fav_list

    override fun subscribe() {
        viewModel.state.observe(viewLifecycleOwner) {
            when (it) {
                ViewState.IDLE -> viewModel.getFavPokemon()
                else -> {}
            }
